...
const Button = ({ variant, hiden, children, hundldeClick, addClass }) => {
    ...
    const sm = `flex items-center text-[0.9rem]  uppercase bg-none rounded-full border-2 ${
        addClass ? addClass : "border-white text-white"
    }  p-[8px] m-[5px] me-[60px] md:me-0 cursor-pointer hover:border-[#2e2e2e] hover:bg-[#2e2e2e] hover:text-[#fff] `;
